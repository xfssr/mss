...
export function Footer(props: { lang: Lang }) {
  return (
    <footer className="border-t border-[rgb(var(--gold))]/10 bg-[rgba(5,6,10,0.8)] backdrop-blur-sm">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 pb-24 sm:pb-12 text-sm text-white/50">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="font-medium text-gold-gradient">© {new Date().getFullYear()} Micro-Screen Studio</div>
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              aria-label="WhatsApp"
              className="hover:text-[rgb(var(--gold-bright))] transition-colors"
            >
            ...
            <span className="text-[rgb(var(--gold))]/20">|</span>
            <a
            ...
            <span className="text-[rgb(var(--gold))]/20">|</span>
            <a
              className="hover:text-[rgb(var(--gold-bright))] focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--gold))] focus-visible:ring-offset-2 focus-visible:ring-offset-black/50 rounded-lg px-3 py-2 transition-all hover:bg-white/5"
              href="#top"
            >

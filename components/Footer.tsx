...
export function Footer(props: { lang: Lang }) {
  return (
    <footer className="border-t border-white/[0.06] bg-[#0A0A0C]">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12 pb-24 sm:pb-12 text-sm text-[#B9B5AC]/60">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              className="hover:text-[#C6A75E] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C6A75E] focus-visible:ring-offset-2 focus-visible:ring-offset-black/50 rounded-lg px-3 py-2 transition-all hover:bg-white/5"
              href="#top"
            >

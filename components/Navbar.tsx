...
const navLinkClass =
  "px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--accent))]";
...
export function Navbar(props: { lang: Lang; onSetLang: (l: Lang) => void }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-white/[0.08] bg-[#070A12]/80 backdrop-blur-md sm:backdrop-blur-lg">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a
          href="#top"
          className="flex items-center min-w-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--accent))] focus-visible:ring-offset-2 focus-visible:ring-offset-black/50 rounded-lg px-2 py-1 transition-opacity hover:opacity-90"
        ...
        <nav className="flex items-center gap-2" aria-label="Main navigation">
          ...
          <button
            type="button"
            className="md:hidden p-2 rounded-lg text-white/70 hover:text-white hover:bg-white/5 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--accent))]"

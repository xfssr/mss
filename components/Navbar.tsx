      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-1">
            <a className="px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all" href="#catalog">
              {t(props.lang, "navCatalog")}
            </a>
            <a className="px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all" href="#about">
              {t(props.lang, "navAbout")}
            </a>
            <a className="px-3 py-2 text-sm text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all" href="#contact">
              {t(props.lang, "navContact")}
            </a>
          </div>

          {/* Language switcher (always visible) */}
          <div className="ml-2 inline-flex rounded-xl border border-white/10 bg-black/30 p-1 backdrop-blur-sm">
            <button
              type="button"

...
export function BookingSection({
  ...
  const inputCls =
    "mt-2 w-full rounded-xl border border-white/10 bg-black/35 px-4 py-2.5 text-base text-white placeholder:text-white/30 outline-none focus:ring-2 focus:ring-[#C81E1E] focus:border-[#C81E1E]/50 transition-all";
    ...
    <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
      ...
      <div className="mt-4">
        <button
          ...
          className="w-full rounded-xl border border-[#1B2A44] bg-[#1B2A44]/50 px-5 py-3 text-sm text-white hover:bg-[#1B2A44] disabled:opacity-50 transition-all"
        >
      ...
      {avail.kind === "available" && hold.kind !== "held" && (
        <div className="mt-3">
          <button
            ...
            className="w-full rounded-xl border border-[#C81E1E] bg-[#C81E1E] px-5 py-3 text-sm text-white hover:bg-[#E02D2D] disabled:opacity-50 transition-all"
          >
